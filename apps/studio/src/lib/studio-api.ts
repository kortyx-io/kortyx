      ...
      data: {
        items: InterruptSchema.array().parse(
          response.data.interrupts.map((interrupt) => ({
            ...
            contract: optional(interrupt.contract),
            ...
            request: optional(interrupt.request),
            requestCaptured: interrupt.requestCaptured,
            ...
            responseValue: optional(interrupt.responseValue),

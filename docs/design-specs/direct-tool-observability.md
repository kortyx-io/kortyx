...
[Workfully PR #756](https://github.com/Workfully-github/workfully-workspace/pull/756) was inspected at head `051f4b20ef8708d8c09c70cd50bace06b3946890`, including [job-tool-caller.ts](https://github.com/Workfully-github/workfully-workspace/blob/051f4b20ef8708d8c09c70cd50bace06b3946890/apps/agents-api/src/services/job-tool-caller.ts) and [answer-brief-question.ts](https://github.com/Workfully-github/workfully-workspace/blob/051f4b20ef8708d8c09c70cd50bace06b3946890/apps/agents-api/src/nodes/hiring-monster-brief/answer-brief-question.ts).
...
The minimal change crosses `@kortyx/hooks`/`kortyx` exports, the runtime hook bridge, native tool dispatcher and replay paths, telemetry contracts, both adapters, API ingestion normalization, and Studio trace/event presentation. No MCP changes or Workfully permission-policy changes are needed. Existing enum validation rejects unknown event types for the entire batch, so release API/Studio contract support before enabling new SDK facts, or negotiate capabilities; otherwise unrelated run telemetry could be discarded along with new tool events.
